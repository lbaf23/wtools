<template>
    <div>
        <div class="row">
            ...
            <div class="col">
                <q-input v-model="urlTextWebServer" type="url" prefix="ws://" style="font-size: medium; font-family: 'Times New Roman',serif"/>
            </div>
            <div class="col-1"></div>
            <div class="col">
    ...
    export default {
        ...
        methods: {
            initWebSocket(){ //初始化weosocket
                ...
                const wsuri = "ws://" + this.urlTextWebServer;
        ...
        created() {
            window.addEventListener("beforeunload",()=>{
                localStorage.setItem('urlTextWebServer', this.urlTextWebServer);
            });
            let t = localStorage.getItem('urlTextWebServer');
            if(t===null) {
                this.urlTextWebServer = '';
            }
            else{
                this.urlTextWebServer = t;
            }
        },
        destroyed() {
            if(this.websock){
